...
public class TransactionsDTO {
	...
	public TransactionsDTO(String streetName, double latitude, double longitude, LocalDateTime timestamp,
			Long bankCardNumber) {
		super();
	...
	public String toString() {
		return "TransactionsDTO [streetName=" + streetName + ", latitude=" + latitude + ", longitude=" + longitude
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TransactionsDTO other = (TransactionsDTO) obj;
