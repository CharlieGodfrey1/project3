...
const IncidentCreateMarker = ({ Location }) => {
    ...
    return (
        <>
            {filteredLocations.map((location, i, a) =>
                <Marker key={i} position={[location.latitude, location.longitude]} icon={i == 0 ? greenIcon : new L.Icon.Default}>
                    <Tooltip>
...
export default IncidentCreateMarker;